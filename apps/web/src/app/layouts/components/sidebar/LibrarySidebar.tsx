...
export const LibrarySidebar = ({
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent px-2 pb-4">
                {status === "loading" && <LibrarySkeleton isExpanded={isExpanded} />}
                {status === "unauthenticated" && <LibraryEmptyState type="unauthenticated" />}
                {status === "empty" &&  <LibraryEmptyState type="empty" />}
                {status === "error" && <LibraryEmptyState type="error" />}
                {status === "ok" && (
